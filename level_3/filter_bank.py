...
_C2048 = mdct_matrix(2048)  # (1024, 2048)
_C256 = mdct_matrix(256)    # (128, 256)


def mdct(x, N):        # Metasxhmatismos apo pedio xronou se pedio syxnothtas
    """Modified Discrete Cosine Transform"""
    C = _C2048 if N == 2048 else _C256
...
def frame_window(frame_type):
    ...
    if frame_type == "OLS":
        ...
        return W        # W(n) = { Wkbd(n), gia 0<= n <1024
                        #          1, gia 1024<= n <1472
                        #          Wkbd(n), gia 1472<= n <1600
                        #          0, gia 1600<= n <2048  }
        ...
        return W        # W(n) = { 0, gia 0<= n <448
                        #          Wkbd(n), gia 448<= n <576
                        #          1, gia 576<= n <1024
                        #          Wkbd(n), gia 1024<= n <2048  }

    # ESH
    return Ws           # W0(n) = W1(n) = ... = W8(n) = Wkbd(n) gia 0<= n <256 = Ws
